/* This program demonstrates how to use struct to model complex data and manage array of objects.
   It also shows how to program for a simple menu-based user interface.
...
int main ()
{
	...
	cout << endl << "Thank you for using Easy Addressbook!" << endl << endl;
